...
| ----------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------- |
| `Routine`         | id, order, name, description, difficulty, estimatedMinutes, category, exercises                | orden positivo; ejercicios no vacíos     |
...
El contenido fuente vive en `src/content/routines/*.json` y se valida estrictamente con Zod antes del seed. MySQL y la API son la fuente de lectura de catálogo, práctica y resumen.
